...
namespace Reflectable
{
    ...
    public sealed class ReflectableGameController : MonoBehaviour
    {
        ...
        [Header("UI")][SerializeField] Text hpText, scoreText, gemsText, turnText, comboText, levelText, characterText, gameOverText; [SerializeField] GameObject pausePanel, gameOverPanel, upgradePanel, characterPanel, stageIntro; [SerializeField] Button powerButton, ricochetButton, extraBallButton, maxHpButton, characterButton; [SerializeField] PlayerCharacterPresenter characterPresenter;
